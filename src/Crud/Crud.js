    ...
    <section className="form_input">
      <div className="part_1">
        <form className="input_set" onSubmit={handleSubmit}>
          <input type="text" placeholder="First Name" name="fname" value={inputdata.fname} onChange={handleChange} />
          <input type="text" placeholder="Last Name" name="lname" value={inputdata.lname} onChange={handleChange} />
          <input type="email" placeholder="Email" name="email" value={inputdata.email} onChange={handleChange} />
          <input type="number" placeholder="Number" name="number" value={inputdata.number} onChange={handleChange} />
          ...
          <div className="yes">
            ...
            <label className="radio_set" htmlFor="yes">
              <input type="radio" id="yes" name="liveindia" value="Yes" checked={inputdata.liveindia == "Yes"} onChange={handleChange} />
              Yes
            </label>
            <label className="radio_set" htmlFor="no">
              <input type="radio" id="no" name="liveindia" value="No" checked={inputdata.liveindia == "No"} onChange={handleChange} />
              No
            </label>
          </div>
          <input type="file" multiple onChange={handelFile} />
          <textarea name="address" placeholder="Address" value={inputdata.address} onChange={handleChange}></textarea>
